...
const Gallery = () => {
    ...
    const galleryImages = [
        {
            id: 1,
            src: "https://images.unsplash.com/photo-1586444248902-2f64eddc13df?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
            title: "Plain Banana Bread",
        ...
        },
        {
            ...
            title: "Coconut Flakes Banana Bread",
            category: "banana-bread",
        },
        {
            id: 3,
    ...
    return (
        <div className="min-h-screen py-12 bg-gradient-light">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <SectionTitle
                    title="Our Gallery"
                    subtitle="Take a visual journey through our banana bread creations and bakery atmosphere"
                    className="mb-16"
                />
              ...
              <span>
                ...
                <div className="bg-custom-orange rounded-3xl p-8 text-center text-white shadow-2xl">
                    <div className="max-w-2xl mx-auto">
                        <h3 className="text-3xl font-bold mb-4">Love Our Banana Bread?</h3>
                        <p className="text-xl mb-6 opacity-90">
                            Visit us in person to experience the full SlicedBliss BakeHouse magic and taste our fresh banana bread varieties!
                        </p>
